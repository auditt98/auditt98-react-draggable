...
export function createCSSTransform(controlPos: ControlPosition, positionOffset: PositionOffsetControlPosition, rotation): Object {
...
export function getTranslation({x, y}: ControlPosition, positionOffset: PositionOffsetControlPosition, unitSuffix: string, rotation): string {
  let translation = `translate(${x}${unitSuffix},${y}${unitSuffix}) rotate(${rotation || 0}deg)`;
  if (positionOffset) {
